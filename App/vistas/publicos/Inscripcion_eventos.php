                ...
                <div class="modal-body" id="contenidoModalUsuario">
                    ...
                    <form method="post" enctype="multipart/form-data" class="card-body  d-flex flex-row justify-content-around" id="form-modal" >
                        ...
                        <div class="<?php if (!isset($datos['usuarioSesion'])):?>col-5<?php else:?>col<?php endif;?>">
                            ...
                            <div class="mt-3 mb-3" id="escondido">
                                <label for="Entrenador">Entrenador: <sup>*</sup></label>
                                <input type="text" name="Entrenador" id="Entrenador" class="form-control form-control-lg">
                            </div>
                            ...
                            <div class="mt-3 mb-3" id="escondido5">
            ...
            if (tipo=="carrera"){
                ...
                for (let i = 0; i < grupos.length; i++) {
                    if (grupos[i]["id_grupo"]==id_evento) {
                        ...
                        document.getElementById("Entrenador").value = grupos[i]["nombre"]+" "+grupos[i]["apellido"];
                        break;
                    }
                }
                ...
                for (let i = 0; i < cursos.length; i++) {
                    if (cursos[i]["id_evento"]==id_evento) {
                        ...
                        document.getElementById("Entrenador").value = cursos[i]["nombre"]+" "+cursos[i]["apellido"];
...
//mostramos los datos del evento seleccionado
        ...
        async function cambiarModal(accion){
            ...
            document.getElementById("Entrenador").readOnly = true
            ...
            document.getElementById("escondido5").removeAttribute("hidden")
            ...
            switch (accion) {
                ...
                case 'inscrip_carrera':
                    //document.getElementById("escondido").removeAttribute("hidden")
                    document.getElementById("escondido").setAttribute("hidden",true)
                    document.getElementById("escondido5").setAttribute("hidden",true)
