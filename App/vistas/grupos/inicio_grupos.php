<?php require_once RUTA_APP.'/vistas/inc/header.php'; ?>
  ...
  <h1>Grupos</h1>
    ...
    <div class="row">
      <div class="col-4"></div>
      <button class="btn btn-outline-success col-4" onclick="add_grupo_modal()" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bi bi-plus-circle"></i></button>
      <div class="col-4"></div>
    </div>
...
<script>
    async function load_grupos() {
      ...
      var enlace="<?php echo RUTA_URL?>/grupos/obtener_gruposs";
        ...
        nomP.forEach(grupo => {
          ...
          gru.setAttribute("class","border border-primary col-6 col-lg-3 text-center p-2 me-1 my-2")
          ...
          editt.setAttribute("class","")
          var btn=document.createElement("button")
          var btn_txt=document.createElement("i")
          btn_txt.setAttribute("class","bi bi-eye")
          btn.appendChild(btn_txt)

          var function_edit="edit_grupo_modal("+grupo.id_grupo+",\""+grupo.nombre+"\")"
          btn.setAttribute("onclick",function_edit)
          btn.setAttribute("class","btn btn-primary col-5 col-lg-2")
    ...
    function add_grupo_modal() {
      var modtitler=document.getElementById("ModalTitler")
        ...
        btn_addadir.setAttribute("class","btn btn-warning")
    ...
    async function edit_grupo(){
       ...
       var enlace="<?php echo RUTA_URL?>/grupos/edit_grupo";
        var nomP="grupo";
