<?php
    ...
    class Socio {
        ...
        public function obtenerUsuariosSocioss(){
            $this->db->query("SELECT id_user, nombre, apellido, CC  FROM User, Socio WHERE User.id_user=Socio.id_socio AND activo=1");
        ...
        public function obtenerGrupos(){
            $this->db->query("SELECT g.id_grupo, g.nombre as nombre_grupo, u.nombre, u.apellido FROM Grupo g, entrenador_grupo eg, Entrenador e, User u 
            WHERE (g.id_grupo=eg.id_grupo AND eg.id_entrenador=e.id_entrenador AND e.id_entrenador=u.id_user)");
